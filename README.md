...
Maintained by [Andrii Holovanov](https://github.com/andrii-holovan). Forked from [jerry800416/3dbinpacking](https://github.com/jerry800416/3dbinpacking), which builds 3D Bin Packing improvements based on [this repository](https://github.com/enzoruiz/3dbinpacking). 

<img src="https://github.com/andrii-holovan/3D-bin-packing/blob/master/img/3.jpeg" width="600"/>
...
1. **fix item float :**
    * `[fix_point = False/True] type bool` The original packaging method did not consider the gravity problem. After the packaging was completed, there were items floating in the air, which greatly reduced the space utilization of the box. I solved this problem and improved the boxing rate.
    ...
    :-------------------------:|:-------------------------:
    <img src="https://github.com/andrii-holovan/3D-bin-packing/blob/master/img/1.jpg" width="400"/>  |  <img src="https://github.com/andrii-holovan/3D-bin-packing/blob/master/img/2.jpg" width="400"/>
...
6. **Container coner :**
    * `[corner = X] type int` Set the size of container corner, the unit is cm, color is black.
    ...
    <img src="https://github.com/andrii-holovan/3D-bin-packing/blob/master/img/7.jpeg" width="600"/>
...
10. **Mixed cube and cylinder :** 
    * `typeof = cube or cylinder`  mixed with cube and cylinder .
    ...
    <img src="https://github.com/andrii-holovan/3D-bin-packing/blob/master/img/4.jpeg" width="600"/>
...
11. **Check stability on item :**
    ...
    * Rule :
    ...
    :-------------------------:|:-------------------------:
    <img src="https://github.com/andrii-holovan/3D-bin-packing/blob/master/img/5.JPG" width="400"/>  |  <img src="https://github.com/andrii-holovan/3D-bin-packing/blob/master/img/6.JPG" width="400"/>
...
12. **distribute items :**
    ...
    * Rule :
    ...
    :-------------------------:|:-------------------------:|:-------------------------:
    Bin1 | <img src="https://github.com/andrii-holovan/3D-bin-packing/blob/master/img/8.JPG" width="400"/>  |  <img src="https://github.com/andrii-holovan/3D-bin-packing/blob/master/img/8.JPG" width="400"/> 
    Bin2 | <img src="https://github.com/andrii-holovan/3D-bin-packing/blob/master/img/9.JPG" width="400"/>  |  <img src="https://github.com/andrii-holovan/3D-bin-packing/blob/master/img/10.JPG" width="400"/> 
...
13. **Write part number on item :**
    ...
    * In order to better distinguish each item, I write part no in the middle of the item, but if I do this, it will be blocked by the color, so it is best to set the alpha value to about 0.2.
    ...
    <img src="https://github.com/andrii-holovan/3D-bin-packing/blob/master/img/11.jpeg" width="600"/>
...
* [Optimizing three-dimensional bin packing through simulation](https://github.com/andrii-holovan/3D-bin-packing/blob/master/reference/OPTIMIZING%20THREE-DIMENSIONAL%20BIN%20PACKING%20THROUGH%20SIMULATION.pdf)
...
[MIT](https://github.com/andrii-holovan/3D-bin-packing/blob/master/LICENSE)